...
class TimelineEvent:
    ...
    def __post_init__(self):
        ...
        if self.timestamp is None:
            self.timestamp = datetime.fromtimestamp(self.valid_at_us / 1_000_000, tz=timezone.utc)
        if self.created_at is None:
            self.created_at = datetime.fromtimestamp(self.recorded_at_us / 1_000_000, tz=timezone.utc)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'data': self.data,
            'causality_vector': self.causality_vector.to_dict() if self.causality_vector else None,
